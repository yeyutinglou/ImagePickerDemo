...
@property (nonatomic) ImageNumberView *numberView;
...
- (instancetype)initWithStyle:(PhotoToolbarStyle)style {
    ...
    _numberView = [[ImageNumberView alloc] initWithFrame:CGRectMake(CGRectGetMinX(_doneBtn.frame)- 27 + 7, (44 - 28)/2, 27, 28)];
